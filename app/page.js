        ...
        <div className="m-4 flex items-center flex-col">
          <div className="flex justify-center flex-col items-center mb-2">
            <h2 className="text-4xl m-0">
              ...
              <p>
                hejsan här skriver jag lite kort om mig. jag är utvecklare och
                är duktig och sånt och här får ni se mina underbara projekt.
                hoppas ni gillar dom. jag är duktig. anställ mig. hejdå, det var
                en beskrivning av mig, eller ja kanske inte så mycket
                beskrivning men aa aja hejdå Check out my projects below
              </p>
            <button className="bg-transparent bg-white w-64 mt-10 border p-4 shadow-xl rounded-3xl hover:cursor-pointer hover:w-96 transistion duration-300 ease-in-out">
              View Resume
            </button>
          </div>
          <div className="flex flex-col items-center">
            <h3 className="mt-24 flex justify-center text-5xl">
              I work with...
            </h3>
